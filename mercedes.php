<html>
  ...
  <!-- Header section end -->
    ...
    <div class="hero-slider owl-carousel">
      ...
      <div class="hs-item set-bg sp-pad" data-setbg="img/hero-slider/mer.jpg">
        <div class="hs-text">
          ...
          <section class="portfolio-section">
            <div class="portfolio-warp">
              <!-- single item -->
              <div class="single-portfolio set-bg" data-setbg="img/portfolio/MER_G.jpg">
                <a href="cal.php?model=GLC&brand=<?php echo $brand;?>" class="portfolio-info">
                  <div class="pfbg set-bg" data-setbg="img/portfolio/MER_G.jpg"></div>
                  <h5>GLC</h5>
