  ...
  <!-- Header section end -->
   ...
   <!-- Page top section start -->
    ...
    <div class="hero-slider owl-carousel">
      ...
      <div class="hs-item set-bg sp-pad" data-setbg="img/hero-slider/por.jpg">
        <div class="hs-text">
          ...
          <section class="portfolio-section">
            <div class="portfolio-warp">
              <!-- single item -->
              <div class="single-portfolio set-bg" data-setbg="img/portfolio/PORC_B.jpg">
                <a href="cal.php?model=Boxster&brand=<?php echo $brand;?>" class="portfolio-info">
                  <div class="pfbg set-bg" data-setbg="img/portfolio/PORC_B.jpg"></div>
                  <h5>BOXSTER</h5>
