<?php  
        ...
        $res = $con->query($sql);
          ...
          while($row = $res->fetch_assoc())
          {
            $VIN= $row['VIN'];
            $image = $row['image'];
            $sql1="select o.engine,o.transmission,o.color,m.body_type from vehicle v,options_t o,model m where v.OID=o.OID and o.MID=m.MID and o.transmission='$trans' and v.VIN='$VIN'";
            $res1=$con->query($sql1);
