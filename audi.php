  ...
  <!-- Header section end -->
   ...
   <!-- Page top section start -->
    ...
    <div class="hero-slider owl-carousel">
      ...
      <div class="hs-item set-bg sp-pad" data-setbg="img/hero-slider/aud.jpg">
        <div class="hs-text">
          ...
          <section class="portfolio-section">
            <div class="portfolio-warp">
              <!-- single item -->
              <div class="single-portfolio set-bg" data-setbg="img/portfolio/audi_a4.jpg">
                <a href="cal.php?model=A4&brand=<?php echo $brand;?>" class="portfolio-info">
                  <div class="pfbg set-bg" data-setbg="img/portfolio/audi_a4.jpg"></div>
                  <h5>A4</h5>
